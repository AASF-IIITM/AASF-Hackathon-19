...
<div class="col-2">
	<center><h1 class="font"> LATEST PROPOSALS </h1></center>
	<hr>
	...
	<div class="fontcontent">
		 ...
		 if(!isset($_GET['submit'])) {
            $p="SELECT * FROM parliament ORDER BY upload_date DESC LIMIT 5 ";
...
$state=$_GET['State'];
		...
		$sql=mysqli_query($conn,"SELECT * FROM parliament WHERE `state`='".$state."' AND `consitutency`='".$const."'") or die("Error: " . mysqli_error($conn));
